...
const Hero = () => (
  <div className="relative z-20 overflow-hidden ">
    ...
    <div className="absolute left-[8%] top-[12%] z-20 gap-4 max-w-[55%] border-l-4 border-cyan-bright p-4 text-left">
      ...
      <h4 className="animate-fade-up text-3xl mt-4 mb-4 text-white animate-delay-75">
    ...
    <div className="flex h-full flex-col gap-2 text-left md:w-3/5">
      <div className="absolute bottom-[12%] right-[8%] z-20 max-w-[55%] border-x-cyan border-r-4 border-white p-4 text-right">
